...
import csc498.dsl3.Dsl3Factory;
 ...
 * @generated
 */
public class Dsl3PackageImpl extends EPackageImpl implements Dsl3Package
{
  /**
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see csc498.dsl3.Dsl3Package#eNS_URI
   * @see #init()
   * @generated
   */
  private Dsl3PackageImpl()
  {
    super(eNS_URI, Dsl3Factory.eINSTANCE);
  }
   ...
   *
   * <p>This method is used to initialize {@link Dsl3Package#eINSTANCE} when that field is accessed.
   ...
   * @generated
   */
  public static Dsl3Package init()
  {
    if (isInited) return (Dsl3Package)EPackage.Registry.INSTANCE.getEPackage(Dsl3Package.eNS_URI);

    // Obtain or create and register package
    Object registeredDsl3Package = EPackage.Registry.INSTANCE.get(eNS_URI);
    Dsl3PackageImpl theDsl3Package = registeredDsl3Package instanceof Dsl3PackageImpl ? (Dsl3PackageImpl)registeredDsl3Package : new Dsl3PackageImpl();

    isInited = true;

    // Create package meta-data objects
    theDsl3Package.createPackageContents();

    // Initialize created meta-data
    theDsl3Package.initializePackageContents();

    // Mark meta-data to indicate it can't be changed
    theDsl3Package.freeze();

    // Update the registry and return the package
    EPackage.Registry.INSTANCE.put(Dsl3Package.eNS_URI, theDsl3Package);
    return theDsl3Package;
  }
   ...
   */
  @Override
  public Dsl3Factory getDsl3Factory()
  {
    return (Dsl3Factory)getEFactoryInstance();
  }
